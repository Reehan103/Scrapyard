...
//for order table
 if(isset($_POST['submit'])){
    ...
    //insert query
    mysqli_query($conn,"INSERT INTO `order` (`user_id`, `address`, `city`, `pincode`, `payment_type`,
     `total_price`, `payment_status`, `order_status`, `added_on`)
     VALUES ('$user_id', ' $address', '$city', '$pincode', '$payment_type', '$total_price', '$payment_status', '$order_status', '$added_on')");
 
    //for order_detail table
    //yo jo last ma order id insert hoi ha us ko fetch kara ga
                                    ...
                                    <div class="accordion__body">
                                        <div class="paymentinfo">
                                            <div class="single-method">
                                               ...
                                               <!-- Pa <input type="radio" name="payment_type" value="Payu" /> -->
                                            </div>
                                            <div class="single-method">
                    ...
                    <div class="col-md-4">
                        <div class="order-details">
                            ...
                            <div class="ordre-details__total">
                                <h5>Order total</h5>
                                <span class="price"><?php echo $cat_total ?></span>
                            </div>
                        </div>
                    </div>
                </div>
