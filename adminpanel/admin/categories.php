...
// Data fetch from database for categories
                  ...
                  <div class="col-xl-12">
                     <div class="card">
                        <div class="card-body">
                           ...
                           <h4 class="box-link" style="text-decoration: underline;"><a href="manage_categories.php">Add Categories</a></h4>
                        </div>
                        <div class="card-body--">
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          ...
                                          <a href='manage_categories.php?type=delete&id=".$row['id']."' class='text-white'>Edit </a></span>&nbsp";
