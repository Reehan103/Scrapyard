        ...
        jQuery.ajax({
            ...
            success:function(result){
                if(type=='update' || type=='remove'){
                    //sameusi page pa redirect kara ga
                    window.location.href=window.location.href;
                }
...
function sort_product_drop(cat_id){
    ...
    window.location.href="http://localhost/adminpanel/frontend/categories.php?id="+cat_id+"&sort="+sort_product_id;
}
    ...
    jQuery.ajax({
        ...
        success:function(result){
            if(result=='not_login'){
                ...
                jQuery('.htq_wishlist').html(result);
            }
